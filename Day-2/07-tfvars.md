...
# Notes addition
1. By default terraform will look for **terraform.tfvars** file , if you used anyother names you can mention the name in "-var-file" parameter in terraform plan / apply commands.
